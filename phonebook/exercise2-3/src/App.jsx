 ...
 const Total = ({ course }) => {
  //sum → accumulator (running total), part → current object in the array, 0 → starting value, Each loop adds part.exercises to sum
  const totalExercises = course.parts.reduce((sum, part) => {
  return sum + part.exercises
  console.log(totalExercises)
  }, 0)

  return <h3><p>Total of {totalExercises} exercises</p></h3>
}
